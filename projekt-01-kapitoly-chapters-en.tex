...
The~designed method switches between AR and CEGIS loop during the~synthesis execution, where an~AR stage refines the~families, ~and CEGIS uses the~obtained refined bounds.

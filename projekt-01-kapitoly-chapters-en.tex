...
\chapter{\toolname{} Architecture}\label{chap:paynt}
...
It features the~synthesis of finite-state probabilistic programs representing a~finite family of program candidates.
It supports an~oracle-guided structure,~thanks to that,~it provides the~flexible combinations of various state-of-the-art algorithms with such structure.
These algorithms effectively reason about the~whole design space and synthesise program candidates that satisfy a~given specification.
These specifications are formulated as a~conjunction of temporal logic constraints and they can include also an~optimising objective.

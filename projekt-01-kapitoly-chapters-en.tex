...
For instance,~the synthesis of parameters rate in stochastic biochemical networks is considered in~\cite{ceska-biochemical},~tuning the model parameters usage of exploiting the~parametric Markov chains in~\cite{model-repair-usage},~and parametric models have applications also when ranking the patches in the~software repair~\cite{learning-correct-code} and for computing perturbation bounds~\cite{nested-approximation}.

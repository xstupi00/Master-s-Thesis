...
When the~analysed family member does not satisfy some given specification $\varphi \in \varPhi$,~the~construction of counter-examples is triggered, which yields a~conflict set with generalised parameters.

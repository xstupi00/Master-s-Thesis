...
It takes a~concrete family member from the~currently analysed family of pMCs $\mathcal{D}$ represented as a~pMC $\mathcal{D}$,~and a~set of specifications $\varPhi_{\neg}$ that the~given family member does not satisfy.
